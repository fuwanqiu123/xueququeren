...
const CONFIG = {
    ...
    // 样式配置
    // ============================================
    // 学区颜色列表（按顺序分配给不同学校，已扩充到40色减少重复）
    districtColors: [
        '#FF6B6B', '#4ECDC4', '#45B7D1', '#96CEB4', '#FFEAA7',
        '#DDA0DD', '#98D8C8', '#F7DC6F', '#BB8FCE', '#85C1E9',
        '#F8C471', '#82E0AA', '#F1948A', '#5DADE2', '#F4D03F',
        '#A569BD', '#48C9B0', '#EC7063', '#5499C7', '#F5B041',
        '#58D68D', '#AF7AC5', '#85C1E9', '#F8C471', '#82E0AA',
        '#E74C3C', '#1ABC9C', '#3498DB', '#2ECC71', '#9B59B6',
        '#E67E22', '#16A085', '#2980B9', '#27AE60', '#8E44AD',
        '#D35400', '#C0392B', '#117A65', '#1F618D', '#145A32'
    ],
